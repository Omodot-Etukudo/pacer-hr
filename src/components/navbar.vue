<template>
  <header class="flex bg-white w-full h-20 px-5 py-3 flex justify-between shadow-md fixed">
    <div class="flex flex-row">
      <div>
        <img class="h-10 ml-5 mr-10 my-2" src="@/assets/pacer-hrlogo.png" alt="Pacer-HR" />
      </div>
      <div class="flex">
...
export default {
  data() {
    return {
      navbuttons: [
        { index: "1", link: "Contact Us" },
        { index: "2", link: "Sign In", linkto: "signin" }
      ]
    };
  }
};
